...
function InterviewResults({ results, onStartNew, onBackToHome }) {
  ...
  return (
    <div className="bg-light min-vh-100 d-flex flex-column">
      ...
      {/* ✅ Main Content */}
      <main
        className="d-flex justify-content-center align-items-center flex-grow-1 py-5 mt-5"
        style={{ width: "100vw" }}
      >
        <div className="container" style={{ maxWidth: "960px", margin: "0 auto" }}>
          ...
          <div className="text-center mb-5">
            <h2 className="fw-bold">
              <i className="fa-solid fa-trophy text-warning"></i> Interview Complete!
            </h2>
            ...
            <div className="col-lg-4 col-sm-12">
              ...
              <div className="card shadow-sm border-0">
                ...
                <div className="card-body">
                  <ul className="mb-0">
                    <li>
                      Practice more {results?.interviewType ?? "interview"} questions
                    </li>
          ...
          <div className="text-center my-5 d-flex flex-wrap gap-3 justify-content-center">
            <Link className="btn btn-primary" to="/toInterviewset">
